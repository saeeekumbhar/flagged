    ...
    <div className="pb-24 max-w-[420px] mx-auto px-4 pt-6 flex flex-col gap-6 relative z-10 pointer-events-auto">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          <button aria-label="Open Settings" onClick={() => onNavigate({ type: 'settings' })} className="w-8 h-8 rounded-full bg-white/10 border border-white/30 flex items-center justify-center shadow-sm active:scale-95 transition-transform hover:bg-white/20 text-white drop-shadow-md">
          ...
          <button aria-label="Sign Out" onClick={handleSignOut} className="h-8 px-3 rounded-full bg-white/10 border border-white/30 flex items-center justify-center gap-1.5 shadow-sm active:scale-95 transition-transform hover:bg-white/20">
      ...
      {/* Flag DNA Share Card */}
      <FlagDNACard profile={profile} logs={logs} aura={aura} isLoading={isLoading} />
