        ...
        return (
          <div className="flex flex-col gap-8 w-full max-w-[390px] mx-auto mt-24 h-full pb-10">
            ...
            <div className="flex flex-col gap-3 overflow-y-auto no-scrollbar">
              ...
              <ChoiceBtn emoji="🚌" label="College Bus" selected={answers.q2 === 'College Bus'} onClick={() => selectAnswer('q2', 'College Bus')} />
              <ChoiceBtn emoji="🚇" label="Public Transport (Bus / Train / Metro)" selected={answers.q2 === 'Public Transport'} onClick={() => selectAnswer('q2', 'Public Transport')} />
              <ChoiceBtn emoji="🚗" label="Private Transport (Car / Auto)" selected={answers.q2 === 'Private Transport'} onClick={() => selectAnswer('q2', 'Private Transport')} />
            </div>
          </div>
        );
